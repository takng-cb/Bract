...
import { isWidgetEnabled, type DashboardWidgetPrefs } from '@/lib/dashboard/widgets'
...
export default async function AutoBodyWidgets({ widgetPrefs }: { widgetPrefs?: DashboardWidgetPrefs | null }) {
  ...
  return (
    <div className="space-y-6">
      {/* 作業進行状況 */}
      {isWidgetEnabled('auto-body-work-progress', widgetPrefs) && (
        <section>
      ...
      {/* 代車中の車両 */}
      {isWidgetEnabled('auto-body-active-loaners', widgetPrefs) && (
        <section>
          <div className="flex items-center justify-between mb-3">
      ...
      {/* 要発注の部品 */}
      {isWidgetEnabled('auto-body-low-stock-parts', widgetPrefs) && (
        <section>
          <div className="flex items-center justify-between mb-3">
      ...
      {/* 未入金の整備 */}
      {isWidgetEnabled('auto-body-receivables', widgetPrefs) && (
        <section>
          <div className="flex items-center justify-between mb-3">
      ...
      {/* 車検期限アラート */}
      {isWidgetEnabled('auto-body-upcoming-inspections', widgetPrefs) && (
        <section>
          <div className="flex items-center justify-between mb-3">
