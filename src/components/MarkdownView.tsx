  ...
  return (
    <div className="text-sm text-zinc-800 leading-relaxed break-words">
      <ReactMarkdown
        ...
        components={{
          h1: ({ children }) => <h1 className="text-xl font-bold text-zinc-900 mt-6 mb-3">{children}</h1>,
          h2: ({ children }) => <h2 className="text-lg font-semibold text-zinc-900 mt-5 mb-2 border-b border-zinc-100 pb-1">{children}</h2>,
          h3: ({ children }) => <h3 className="text-base font-semibold text-zinc-800 mt-4 mb-2">{children}</h3>,
