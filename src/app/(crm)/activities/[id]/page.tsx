    ...
    <div className="p-4 md:p-8 max-w-2xl">
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <h1 className="text-2xl font-bold text-zinc-900">{activityRow.subject}</h1>
        ...
        <div className="flex items-center gap-2">
          <Link href={`/activities/${id}/edit`} className="px-4 py-2 border border-zinc-300 text-sm font-medium rounded-md hover:bg-zinc-50 transition-colors">編集</Link>
