...
| auto-body | `bract-crm-car` (`bract-crm-car.vercel.app`) | `ep-young-meadow-aoo7z9eq` |
| base | （将来追加予定） | `ep-proud-band-ao22d0oc` |

> 2026-06-14: 本番2本は旧リポ `Bract-CRM` から **新リポ `takng-cb/Bract`** へ移行済み（ADR-0028 / #18）。旧 `bract-car.vercel.app` は無効エイリアス。
