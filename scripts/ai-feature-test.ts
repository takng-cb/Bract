...
const CREATE_CASES: CreateCase[] = [
  ...
  { id: 'C6', name: '領収書 → 経費（支払先・登録番号も抽出）',
    text: '領収書 さくらタクシー株式会社 2026年6月10日 合計3,400円（消費税10%込）登録番号 T1234567890123 顧客訪問の移動',
    expect: { book: '経費', fields: [
      { label: '金額（円）', value: /3400/ },
      { label: '支払先', value: /さくらタクシー/ },
      { label: 'インボイス登録番号', value: /T1234567890123/ },
    ] } },
